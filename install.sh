...
echo ""
echo "  Run claude-popup wherever you'd normally run 'claude':"
echo -e "    ${GREEN}claude-popup${NC}    (or ${GREEN}$INSTALL_DIR/run.sh${NC} without the alias)"
echo ""
echo "  In an editor terminal it attaches you to the shared tmux session."
echo "  Triggered from anywhere else (or by Claude's Notification hook), it"
echo "  opens a floating window attached to the same live conversation."
echo ""
echo "  Press Ctrl+D or close the popup to send Claude back to the background."
echo ""
